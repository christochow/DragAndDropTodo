...
var TodoInputComponent = /** @class */ (function () {
    ...
    TodoInputComponent.ctorParameters = function () { return [
...
var TodoComponent = /** @class */ (function () {
    function TodoComponent(cookieService, todoService) {
        this.cookieService = cookieService;
        this.todoService = todoService;
        var cookieString = cookieService.get('todoList');
...
/* harmony import */ var angular2_cookie_law__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! angular2-cookie-law */ "./node_modules/angular2-cookie-law/fesm5/angular2-cookie-law.js");
...
var TodoService = /** @class */ (function () {
    function TodoService(cookieService) {
        this.cookieService = cookieService;
        this.list = [];
    }
    TodoService.prototype.setTodo = function (val) {
        this.list = val;
    };
    ...
    TodoService.prototype.removeItem = function (index) {
        this.list.splice(index, 1);
        this.saveList();
    };
    TodoService.prototype.updateList = function (oldIndex, newIndex) {
        this.list.splice(newIndex, 0, this.list.splice(oldIndex, 1)[0]);
    };
    TodoService.prototype.saveList = function () {
...
var TodolistComponent = /** @class */ (function () {
    ...
    TodolistComponent.prototype.dropEvent = function (event) {
